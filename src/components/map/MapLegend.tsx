...
export function MapLegend() {
  return (
    <div
      className="map-legend pointer-events-auto absolute right-4 z-[1000] max-w-[min(12rem,calc(100vw-2rem))] rounded-[var(--radius-card)] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-3 shadow-[var(--shadow-sm)] max-md:bottom-[calc(env(safe-area-inset-bottom)+var(--mobile-nav-height,4rem)+var(--action-bar-height,3.5rem)+1rem)] md:bottom-4"
    >
