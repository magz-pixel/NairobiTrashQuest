  ...
  return (
    <section className="relative grid min-h-[max(680px,100svh)] w-full grid-cols-1 gap-5 overflow-hidden bg-canvas p-4 text-ink sm:p-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,.92fr)] lg:gap-8 lg:p-8 max-[768px]:block max-[768px]:min-h-[100svh] max-[768px]:p-0 max-[768px]:text-white">
      <div className="relative z-10 order-2 flex min-w-0 flex-col px-1 lg:order-1 lg:pl-5 max-[768px]:h-full max-[768px]:min-h-[100svh] max-[768px]:p-5 max-[420px]:p-4">
        <div className="flex items-center gap-8 pt-1 text-sm font-semibold text-ink sm:gap-12">
          <Link to="/" className="shrink-0 text-sm font-extrabold uppercase tracking-[.08em]">Fix Nairobi</Link>
          <span className="hidden text-xs font-medium text-muted sm:inline max-[768px]:text-white/70">Nairobi, Kenya</span>
        ...
        <div className="mt-auto max-w-3xl py-10 sm:py-14 lg:py-16 max-[768px]:py-8 max-[420px]:py-5">
          <p className="mb-5 text-[11px] font-extrabold uppercase tracking-[.22em] text-muted max-[768px]:text-white/70">Fix Nairobi × XPNC / field note 01</p>
          <h1 className="m-0 max-w-3xl text-[clamp(2.7rem,5.2vw,5.8rem)] font-semibold leading-[1.02] tracking-[-.055em] text-ink max-[768px]:text-[clamp(2rem,9.2vw,3rem)] max-[768px]:leading-[1.14] max-[768px]:text-white max-[420px]:text-[clamp(1.8rem,8.6vw,2.4rem)]">Nairobi, show us <span className="inline-block rounded-[16px] bg-[radial-gradient(circle_at_30%_30%,#45c6ae,#075e50_56%,#063b32)] px-[.2em] pb-[.14em] pt-[.06em] text-white shadow-[0_12px_30px_rgba(6,59,50,.16)] max-[768px]:rounded-xl">where it hurts.</span></h1>
      ...
      <div className="order-1 isolate relative min-h-[430px] overflow-hidden rounded-[26px] bg-emerald-950 shadow-[0_24px_80px_rgba(6,59,50,.18)] lg:order-2 lg:min-h-0 max-[768px]:absolute max-[768px]:inset-0 max-[768px]:min-h-0 max-[768px]:rounded-none max-[768px]:shadow-none">
        ...
        <div className="absolute bottom-0 right-0 rounded-tl-[36px] bg-white px-5 py-4 text-ink sm:px-7 sm:py-5 max-[768px]:hidden"><Link to="/map" aria-label="Open the field map" className="text-xs font-extrabold uppercase tracking-[.12em] hover:text-emerald-700">Open the map ↗</Link></div>
      </div>
