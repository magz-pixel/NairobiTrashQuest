...
function LedgerManageInner() {
    ...
    return (
      <div className="rounded-2xl border border-amber-400/30 bg-amber-950/40 p-6 text-amber-100">
        ...
        <p className="mt-2 text-sm text-amber-100/80">
          Your profile needs <code className="text-gold-200">is_admin = true</code> in
  ...
  return (
    <div className="space-y-8">
      {usingLocal && (
        <p className="rounded-lg border border-gold-400/40 bg-amber-950/30 px-3 py-2 text-sm text-amber-100">
      ...
      <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-5">
        ...
        <label className="block text-xs text-teal-200/80">
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-white/15 bg-emerald-950 px-3 py-2 text-white"
            required
          />
        </label>
        <label className="block text-xs text-teal-200/80">
